...
# print("The value of d is True since one of the or statements is true.")
...
# print ("The value of o is False since the valiable m and n are not equal.")
...
savings = int(input("How much do you have saved? "))
...
if stock == "amzn":
	num_stock = int(savings/amazon)
	price = amazon
elif stock == "aapl":
	num_stock = int(savings/Apple)
	price = Apple
elif stock == "fb":
	num_stock = int(savings/Facebook)
	price = Facebook
elif stock == "goog":
	num_stock = int(savings/Google)
	price = Google
elif stock == "msft":
	num_stock =int(savings/Microsoft)
	price = Microsoft
else:
	num_stock = ""
...
if num_stock == "":
	...
	print(f"{name} has {savings} and he can buy {num_stock} shares of {stock} at the current price of {price}")
