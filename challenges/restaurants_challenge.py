...
fav_restaurants = {
    "Mi Tierrita": ["769 Suffolk Ave, Brentwood, NY 11717", "Banquet Chicken", "10 AM - 11 PM"],
    "Gerardi's Bar and Grill": ["160 Adams Ave, Hauppauge, NY 11788", "Steak", "11:30 AM - 10 PM"],
    "KFC": ["150 W Suffolk Ave, Central Islip, NY 11722", "Chrispy Chicken Bucket", "10:30 AM - 1 AM"]
}
...
fav_restaurants.pop("Gerardi's Bar and Grill")
print(fav_restaurants)
